...
contract AngelicaPickles is ERC20, Ownable {
    ...
    uint256 public _maxTransactionLimit = 20000 * 10 ** decimals();
    uint256 public transactionTax = 5;
    ...
    function _transfer(
        ...
        require( amount <= _maxTransactionLimit, "max limit reached");

        uint256 fee = amount * transactionTax/ 100;
